...
app.layout = dbc.Container([
    ...
    dbc.Row([
        dbc.Tabs([
            dbc.Tab([
                ...
                dbc.Row([
                    dbc.Col([
                        ...
                        dbc.Popover(
                            "Displays the available databases to which the main sales analysis can be performed.",
                ...
                dbc.Row([
                    dbc.Col([
                        ...
                        dbc.Popover(
                            "Displays the available databases to which secondary sales analysis can be performed.",
                ...
                dbc.Row([
                    dbc.Col([
                        dbc.Spinner(children=[html.Button('Start Sales Analysis', id='iniciar', n_clicks=0),], size="lg", color="primary",
                                    type="border", fullscreen=True,),

                    ])

                ]),
            ], label="Enter Databases", label_style={'color': '#082255', 'font-family': "Franklin Gothic"}),
            dbc.Tab([
                dbc.Row([
                    dbc.Col(html.H1(
                        "Sales Tunnel",
            ...
            ], label="Sales Tunnel", label_style={'color': '#082255', 'font-family': "Franklin Gothic"}),
            dbc.Tab([
                dbc.Row([
                    dbc.Col(html.H1(
                        "State Summary",
            ...
            ], label="State Summary", label_style={'color': '#082255', 'font-family': "Franklin Gothic"}),
            ...
            dbc.Tab([
                ...
                dbc.Row([
                    dbc.Col(html.H4(
                        "Offers that are in both databases and have changed their state",
                        style={'textAlign': 'center', 'color': '#082255', 'font-family': "Franklin Gothic"}),
                        width=12, )
                ]),
                # html.Br(),
                ...
                dbc.Row([
                    dbc.Col(html.H4(
                        "Offers found only in the main database (new)",
                        style={'textAlign': 'center', 'color': '#082255', 'font-family': "Franklin Gothic"}),
                        width=12, )
                ]),
                dbc.Row(
            ...
            ], label="Comparison", label_style={'color': '#082255', 'font-family': "Franklin Gothic"}),
            dbc.Tab([
                dbc.Row([
                    dbc.Col([
                        html.Button("Download Main Database to Excel", id="btn_xlsx"),
                        dcc.Download(id="download-dataframe-xlsx"),
                    ]),
                ]),
                dbc.Row([
                    dbc.Col([
                        html.Button("Download Secondary Database to Excel", id="btn_xlsx2"),
                        dcc.Download(id="download-dataframe-xlsx2"),
                    ]),
                ]),
            ], label="Download", label_style={'color': '#082255', 'font-family': "Franklin Gothic"}),
...
def tunel_de_ventas(value_interval, value_linea, df, value_estado, df_secundaria, value_principal, value_secundaria):
    ...
    pie_chart_prospeccto = crear_pie_chart(dfEstadoSumCant, 'Suma Prospecto', 'Estado', 'Sales Value Prospectus')

    pie_chart_cantidad = crear_pie_chart(dfEstadoSumCant, 'Cantidad', 'Estado', 'Sales Quantity Prospectus')
    ...
    fig_barras_ventas_pros_cant = crear_figura_barras(dfEstadoSumCant, 'Estado', 'Cantidad',
                                                      "Sales Quantity Prospectus", "State", "Quantity")

    fig_barras_ventas_pros_sum = crear_figura_barras(dfEstadoSumCant, 'Estado', 'Suma Prospecto',
                                                      "Sales Value Prospectus", "State", "Prospectus Sum [COP]")
    ...
    crear_caja(fig, 105, 365, 'Potentials', 397, 365, clientesPotenciales, 690, 365, ventaProsPot)
    crear_caja(fig, 150, 278, 'Leads', 397, 278, clientesLeads, 653, 278, ventaProsLead)
    crear_caja(fig, 189, 191, 'Development', 397, 191, clientesDesa, 620, 191, ventaProsDesa)
    crear_caja(fig, 226, 106, 'Proposal', 397, 106, clientesProp, 573, 106, ventaProsProp)
    crear_caja(fig, 260, 30, 'Won', 397, 30, clientesGanada, 540, 30, ventaProsGanada)
    crear_caja(fig, 751, 191, 'Lost', 753, 106, clientesPerdida, 730, 30, ventaProsPerdida)
    ...
    figTipodePotencialPotencial.update_layout(title="Sales Value Prospectus", xaxis_title="Date", yaxis_title="Value [COP]")
    ...
    figTipodePotencialCantidad.update_layout(title="Sales Quantity Prospectus", xaxis_title="Date", yaxis_title="Quantity")
    ...
    figTipodePotencialPotencial2.update_layout(title="Sales Value Prospectus", xaxis_title="Date", yaxis_title="Value [COP]")
    ...
    figTipodePotencialCantidad2.update_layout(title="Sales Quantity Prospectus", xaxis_title="Date", yaxis_title="Quantity")
    ...
    fig_barras_ventas_pros_sum_primaria_only.update_layout(
        ...
        title_font_family="Franklin Gothic",
        barmode='group',
        title="Sales Value Prospectus",
        xaxis_title="State",
        yaxis_title="Prospectus Sum [COP]"
    )
